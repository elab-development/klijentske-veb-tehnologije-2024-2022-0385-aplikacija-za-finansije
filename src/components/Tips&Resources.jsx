...
class TipsResources extends Component {
    ...
    nextTip = () => {
        ...
        const nextIndex = (prevState.currentTipIndex + 1) % prevState.tips.length;
            return {
    ...
    render() {
        ...
        return (
            <div className="tips-resources">
                ...
                <p>{currentTip.text}
                    <a href={currentTip.link} target="_blank" rel="noopener noreferrer">
                        Learn more
                    </a>
                </p>
                <div className="tips-resources-dropdown">
                    ...
                    >
                        {tips.map((tip, index) => (
                            <option key={index} value={index}>{`Tip ${index + 1}`}</option>
                        ))}
                    </select>
                </div>
            </div>
